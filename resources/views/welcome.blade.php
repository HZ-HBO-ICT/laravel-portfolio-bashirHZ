    ...
    <main class="mt-0">
        <div class="container">
            ...
            <div class="row align-items-md-stretch">
                ...
                <div class="col-md-4">
                    <div class="d-flex flex-column align-items-stretch flex-shrink-0 bg-light border rounded-3 p-3">
                        <h2>Articles</h2>
                        <ul class="list-group list-group-flush">
                            @foreach($articles as $article)
                                <li class="list-group-item  py-3 lh-tight">
                                    ...
                                    <p>{{$article->excerpt}}</p>
                                    <a href="/articles/{{$article->id}}" class="btn btn-outline-secondary">Read more!</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
